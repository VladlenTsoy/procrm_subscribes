...
<!-- Modal -->
<div class="modal fade" id="editorSubscribeModal" tabindex="-1" aria-labelledby="editorSubscribeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content data modal-subscribe-data">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
                <h4 class="modal-title"> <?php echo _l('loading') ?>... </h4>
            </div>
